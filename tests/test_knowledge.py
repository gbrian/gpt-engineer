...
def test_knowledge_chat_ai_class():
    chat = KnowledgeChat('tests/data', suffixes=['.py'], language=Language.PYTHON, ids=['test_id'])
...
def test_knowledge_chat_parse_chat_function():
    chat = KnowledgeChat('tests/data', suffixes=['.py'], language=Language.PYTHON, ids=['test_id'])
...
def test_knowledge_chat_db_class():
    chat = KnowledgeChat('tests/data', suffixes=['.py'], language=Language.PYTHON, ids=['test_id'])
...
def test_knowledge_chat_to_files_and_memory_function():
    chat = KnowledgeChat('tests/data', suffixes=['.py'], language=Language.PYTHON, ids=['test_id'])
...
def test_knowledge_chat_archive_function():
    chat = KnowledgeChat('tests/data', suffixes=['.py'], language=Language.PYTHON, ids=['test_id'])
