<script setup>
import MarkdownVue from '../components/Markdown.vue'</script>
<template>
  <div class="flex flex-col h-full justify-between">
    ...
    <div class="mt-2 grow relative" v-if="profile">
      <div :class="['absolute top-0 left-0 right-0 bottom-0 border-slate-200 p-2 rounded-md overflow-auto',
            editProfile && 'bg-neutral text-neutral-content']">
        <pre class="text-wrap min-h-40" contenteditable="true" ref="profileContentEditor" v-if="editProfile">
          {{ profile.content }}
        </pre>
